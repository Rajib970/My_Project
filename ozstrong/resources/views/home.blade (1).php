	...
	<section id="fst_sec" style="">
		<div class="row d-flex justify-content-center" id="fst_sec_row1">
			<div class="col-xl-7" style="padding: 5%">
			    	<a href="https://ozstrong.tuhinbanik.com/gallery" class="btn btn-primary" style="float:right;margin-top:48%; " >View Our Gallery</a>
			</div>
			<div class="col-xl-3 card shadow-lg d-flex justify-content-center  p-3 d-xl-block d-xxl-block d-none d-sm-none d-md-none d-lg-none" style="margin-top:4%; background-image:linear-gradient(to bottom, #fbfcfc ,#f2f3f4, #e5e7e9 );" id="fst_sec_row1_col2">
	...
	<section>
		...
		<section class="" id="fth_sec">
			<div class="row" id="fth_sec_row1">
			    <a href="/roller-door-openers">
				<div class="col-xl-4 p-3">
				    
					<div class="card"  >
					     
						<div class="card-img-wrap" >
						   <a href="https://ozstrong.tuhinbanik.com/roller-door-openers">
						   	<div id="background" onclick='window.location.href="https://ozstrong.tuhinbanik.com/roller-door-openers"'>
							...
							<div class="card-img-overlay d-flex justify-content-center">
								...
								<div class="card-body text-center" >
									<a href="roller-garage-doors" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
										ROLLER GARAGE DOORS
									</a>
								</div>
								</a>
				...
				<div class="col-xl-4 p-3">
					<div class="card"  >
						<div class="card-img-wrap" >
							<a href="https://ozstrong.tuhinbanik.com/sectional-door-openers"><img class="card-img" src="{{URL::asset('public/img/sectional-door.webp')}}" alt="sectional garage door" style="height:18rem;"></a>
							<div class="card-img-overlay d-flex justify-content-center">
								<div class="card-body text-center" >
									<a href="sectional-door-openers" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
				...
				<div class="col-xl-4 p-3">
					<div class="card"  >
						<div class="card-img-wrap" >
							<a href="https://ozstrong.tuhinbanik.com/new-garage-doors"><img class="card-img" src="{{URL::asset('public/img/garage-door-openers.webp')}}" alt="garage door openers" style="height:18rem;"></a>
							<div class="card-img-overlay d-flex justify-content-center">
								<div class="card-body text-center" >
									<a href="new-garage-doors" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
										GARAGE DOOR OPENERS
									</a>
								</div>
							</div>
			...
			<div class="row" id="fth_sec_row2">
				<div class="col-xl-4 p-3">
					<div class="card"  >
						<div class="card-img-wrap" >
							<a href="https://ozstrong.tuhinbanik.com/garage door repair"><img class="card-img" src="{{URL::asset('public/img/garage-door-repair.webp')}}" alt="garage door repair" style="height:18rem;"></a>
							<div class="card-img-overlay d-flex justify-content-center">
								<div class="card-body text-center" >
									<a href="garage-door-repair" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
										GARAGE DOOR REPAIR
									</a>
								</div>
							</div>
				...
				<div class="col-xl-4 p-3">
					<div class="card">
						<div class="card-img-wrap" >
							<a href="https://ozstrong.tuhinbanik.com/repair-service"><img class="card-img" src="{{URL::asset('public/img/garage-door-servicing.webp')}}" alt="garage door service" style="height:18rem;"></a>
							<div class="card-img-overlay d-flex justify-content-center">
								<div class="card-body text-center" >
									<a href="repair-service" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
										GARAGE DOOR SERVICE
									</a>
								</div>
							</div>
				...
				<div class="col-xl-4 p-3">
					<div class="card">
						<div class="card-img-wrap" >
							<a href="https://ozstrong.tuhinbanik.com/garage-door-remotes"><img class="card-img" src="{{URL::asset('public/img/remotes.webp')}}" alt="garage door service" style="height:18rem;"></a>
							<div class="card-img-overlay d-flex justify-content-center">
								<div class="card-body text-center" >
									<a href="garage-door-remotes" class="btn btn-light fs-5 text-center text-dark w-100 rounded-0" id="card_btn">
										GARAGE DOOR REMOTES
									</a>
								</div>
							</div>
		...
		<section class="p-3">
            ...
            <section class="raqpad">
                
                <div class="container bgcol1">
                    
<h2 style="text-align : center;padding-bottom:10px;color:white;">Frequently Asked Questions</h2>

<button class="accordion"><span style="font-weight:bold;color:white;">Q. What are the different types of garage door construction?</span></button>
<div class="panel">
<div class="" style="color:white;">A. There are four main types of garage doors in Auckland  and the basic difference between each one is in the way that they open.<br>
The opening style is usually determined by the physical space available in and around your garage entrance, but aesthetics can also play a part when making your decision if you are lucky enough to have a garage that can accommodate more than one style.<br>
Each type is available in various materials and finishes but they will generally fall into one of the following categories:<br>
1.    Sectional - They slide upwards into the ceiling space with each section moving independently of each other in order to facilitate the way it bends through the top of the garage opening and into the runners that guide it across the ceiling. At Auckland Garage Doors, we offer sectional doors in a wide range of styles and materials to ensure that the final finish complements the overall feel of your house.<br>
2.    Roller - Similar to the sectional door in that they are guided straight up towards the ceiling, but the main difference being that they roll around themselves at the top rather than remaining flat and travelling across the ceiling space. As a result, the sections are much smaller in order to make this logistically possible. Get in touch to learn more about roller doors in Auckland and see what options you have available to you.<br>
3.    Upswing or tilting - These one-piece doors move outwards from the bottom, then swing up and remain in one flat piece as they come to rest horizontally across the ceiling.<br>
4.    Carriage - These older style doors open out from the centre in the same way barn doors would. It's becoming a less popular style of garage door, and now they are often installed as sectional sliding doors and the carriage style is simply created with aesthetic touches.</div>
</div>

<button class="accordion"><span style="font-weight:bold;color:white;">Q. What is the best garage door?</span></button>
<div class="panel">
<div class="" style="color:white;">
    
<p class="font_9">A. The best garage door type for you will depend on a number of factors.</p>

<ul>
	<li>There's the practicality of how the door functions - this will usually depend on the space available in and around the garage entrance.</li>
	<li>You will want to consider the overall look and how it complements the facade of your house. Garage doors can take up to about 20% of the front aspect of a residential building and could make a difference to its value and saleability if you come to sell your home in the future.</li>
</ul>
Materials make a difference. Auckland Garage Doors offer a range of aluminium, Colorsteel, and cedar. While wood can add curb appeal, it is also more expensive to produce and install. Colorsteel and aluminium are more durable and usually require less maintenance. Contact us for more expert advice.
</div>
</div>


<button class="accordion"><span style="font-weight:bold;color:white;">Q. Should I get insulated or non-insulated garage doors?</span></button>
<div class="panel">
<div class="" style="color:white;"><div class="font_8">
<p class="font_9">A. There are benefits to choosing insulated garage doors in Auckland. The obvious reason is to retain the heat inside your home. An energy-efficient door will trap the heat where you want it and help keep the rest of the house warm in the winter.</p>

<p class="font_9">Another good reason is to add value to your house. When you come to sell your home, potential buyers are becoming increasingly interested in the energy efficiency of a house, not just for the heating costs, but for environmental reasons too.</p>
Garages that also double as workstation require insulated garage doors to prevent the area from getting too cold.</div>
</div>
</div>

<button class="accordion"><span style="font-weight:bold;color:white;">Q. What safety features are important in a garage door opener?</span></button>
<div class="panel">
<div class="" style="color:white;"><div class="font_8">
<p class="font_9">A. The most important safety features in a garage door opener are:</p>

<ul>
	<li>Auto-reverse - If a garage door comes down and hits a person or car, then you want it to go back up again so as not to cause serious damage. Garage doors  can be very heavy, and you don't want the full force of it pushing down on something that is trapped below it.</li>
	<li>Manual control - It may seem counterproductive to have an automatic door installation and then add a manual operation as well, but if the power goes out in your home and you need to get the garage door open, you don't want to be pushing against a motor to try and open it. Emergencies can happen and sometimes the garage maybe your nearest point of exit from the house.</li>
</ul>
Safety lights. If you need to manually get your door open due to a power cut, then it's likely that the lights in your house won't be working either.</div>
</div>
</div>

<button class="accordion"><span style="font-weight:bold;color:white;">Q. How much will it cost to repair my garage door?</span></button>
<div class="panel">
<div class="" style="color:white;"><div class="font_8">
<p class="font_9">A. The garage door repair cost will depend on the damage and the parts to be replaced. The most common issue in garage door repair is the garage door spring replacement. For a more accurate estimate, give us a call today.</p>
</div>
</div>
</div>
