  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="/Projects/ozstrong/admin" >
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="/Projects/ozstrong/subscribers">
          ...
          <table id="table_id" class="display">
            ...
            <tbody>
             ...
             <tr>
              ...
              <td> <a href="/Projects/ozstrong/contact-lead/{{$lead->id}}" class="btn btn-sm btn-primary"> Contact </td>
                @else
                <td class="text-success font-weight-bold">  Contacted </td>
                <td> <a class="btn btn-sm btn-info disabled "> Contacted </a> </td>
                @endif
                <td> <a href="/Projects/ozstrong/delete-lead/{{$lead->id}}" class="btn btn-sm btn-danger"> Delete  </a> </td>
              </tr>
            </tr>
            @endforeach
          </tbody>
